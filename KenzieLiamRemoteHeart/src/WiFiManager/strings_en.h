...
"<form action='/wifi'    method='get'><button>Connect Heart to Wifi</button></form><br/><br/>\n", // MENU_WIFI
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Your heart is now trying to connect to the wifi network.<br/>If the status light on your heart turns blue or green, it succesfully connected to wifi.<br />If it stays orange for more than 10 seconds, go back and make sure you entered the right wifi network and password.<br/><br/>You can close this page</div>";
